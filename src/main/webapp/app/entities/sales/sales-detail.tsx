  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/sales" replace color="info" className="botonBack-details">
        ...
        &nbsp;
        <Button tag={Link} to={`/sales/${salesEntity.id}/edit`} replace color="primary" className="botonEdit-detail text-center">
