  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="testApp.sales.home.createOrEditLabel" className="titulo-salesedit">
            <Translate contentKey="testApp.sales.home.createOrEditLabel">Create or editar a Sales</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : salesEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="sales-id" className="titulo-descrip" >
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="sales-description" className="titulo-descrip">
              ...
              <AvGroup>
                <Label id="stateLabel" for="sales-state" className="titulo-state">
              ...
              <AvGroup>
                <Label id="dateLabel" for="sales-date" className="titulo-date">
                  <Translate contentKey="testApp.sales.date">Date</Translate>
                </Label>
                <AvField id="sales-date" type="date" className="form-control" name="date" />
              </AvGroup>
              <Button tag={Link} id="cancel-save" to="/sales" replace className="btn-updateback">
              ...
              &nbsp;
              <Button className="btn-updatesave" id="save-entity" type="submit" disabled={updating}>
